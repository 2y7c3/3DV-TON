...
class UNet2DConditionModel(ModelMixin, ConfigMixin, UNet2DConditionLoadersMixin):
    ...
    def from_pretrained_2d(
        ...
        unet_config["mid_block_type"] = "UNetMidBlock2DCrossAttn"
        ...
        if state_dict["conv_in.weight"].shape[1] != unet_additional_kwargs["in_channels"]:
            zero_initalize=torch.zeros((320,1,3,3), dtype=torch.float32)
            state_dict["conv_in.weight"] = torch.cat([state_dict["conv_in.weight"],zero_initalize],dim=1)
