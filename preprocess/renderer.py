...
class Renderer:
    ...
    def create_renderer(self):
        blendparam = BlendParams(1e-4, 1e-8, np.array(ImageColor.getrgb('gray')) / 255.0)
    ...
    def render_mesh(self, vertices, background=None, colors=[0.8, 0.8, 0.8], VI=50, normal=True):
        ...
        results = torch.flip(self.renderer(mesh, cameras=self.cameras, lights=self.lights), [1, 2])
